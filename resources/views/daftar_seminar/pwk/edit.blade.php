                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                            @if ($data->syarat_1 != '')
                            <tr>
                                <td><a href="{{ url('/mahasiswa/seminar', $data->syarat_1) }}">Lembar bimbingan skripsi (minimal 10x bimbingan)</a></td>
                                <td>
                                    @if ($data->status_1 == 1)
                            ...
                            @if ($data->syarat_2 != '')
                            <tr>
                                <td><a href="{{ url('/mahasiswa/seminar', $data->syarat_2) }}">Sertifikat pesantren mahasiswa baru</a></td>
                                <td>
                                    @if ($data->status_2 == 1)
                                    <span class="badge badge-success">Diterima</span>
                                    @else
                            ...
                            @if ($data->syarat_3 != '')
                            <tr>
                                <td><a href="{{ url('/mahasiswa/seminar', $data->syarat_3) }}">Sertifikat pesantren calon sarjana (Jika sudah ada)</a></td>
                                <td>
                                    @if ($data->status_3 == 1)
                                    <span class="badge badge-success">Diterima</span>
                                    @else
                            ...
                            @if ($data->syarat_4 != '')
                            <tr>
                                <td><a href="{{ url('/mahasiswa/seminar', $data->syarat_4) }}">Transkrip nilai yang di print SIAA program studi (Jika sudah ada)</a></td>
                                <td>
                                    @if ($data->status_4 == 1)
                                    <span class="badge badge-success">Diterima</span>
                                    @else
                            ...
                            @if ($data->syarat_5 != '')
                            <tr>
                                <td><a href="{{ url('/mahasiswa/seminar', $data->syarat_5) }}">Sertifikat TOEFL (Skor Minimal 475) (Jika sudah ada)</a></td>
                                <td>
                                    @if ($data->status_5 == 1)
                                    <span class="badge badge-success">Diterima</span>
                                    @else
                            ...
                            @if ($data->syarat_6 != '')
                            <tr>
                                <td><a href="{{ url('/mahasiswa/seminar', $data->syarat_6) }}">Bukti bebas pinjaman perpustakaan</a></td>
                                <td>
                                    @if ($data->status_6 == 1)
                                    <span class="badge badge-success">Diterima</span>
                                    @else
                            ...
                            @if ($data->syarat_7 != '')
                            <tr>
                                <td><a href="{{ url('/mahasiswa/seminar', $data->syarat_7) }}">Sertifikat SKKFT (Jika sudah ada)</a></td>
                                <td>
                                    @if ($data->status_7 == 1)
                                    <span class="badge badge-success">Diterima</span>
                                    @else
                            ...
                            @if ($data->syarat_8 != '')
                            <tr>
                                <td><a href="{{ url('/mahasiswa/seminar', $data->syarat_8) }}">Bukti KRS (pengambilan MK. Skripsi)</a></td>
                                <td>
                                    @if ($data->status_8 == 1)
                                    <span class="badge badge-success">Diterima</span>
                                    @else
                            ...
                            @if ($data->syarat_9 != '')
                            <tr>
                                <td><a href="{{ url('/mahasiswa/seminar', $data->syarat_9) }}">Bukti pembayaran DPP Mk. Skripsi</a></td>
                                <td>
                                    @if ($data->status_9 == 1)
                                    <span class="badge badge-success">Diterima</span>
                                    @else
                            ...
                            @if ($data->syarat_10 != '')
                            <tr>
                                <td><a href="{{ url('/mahasiswa/seminar', $data->syarat_10) }}">Bukti pembayaran sidang pembahasan</a></td>
                                <td>
                                    @if ($data->status_10 == 1)
                                    <span class="badge badge-success">Diterima</span>
                                    @else
