            ...
            <form class="form-horizontal" action="{{ route('seminar_ti.update', $data->id) }}" method="post" enctype="multipart/form-data">@csrf
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-12">
                                <label class="col-sm-3 col-form-label">Formulir pendaftaran Seminar terisi</label>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label class="col-sm-3 col-form-label">Copy Berita Acara Pembimbingan / Kartu Bimbingan</label>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label class="col-sm-3 col-form-label">Persetujuan Seminar dari Dosen Pembimbing</label>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label class="col-sm-3 col-form-label">Fotocopy Kwitansi Pembayaran Seminar dan Bimbingan Tugas Akhir</label>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label class="col-sm-3 col-form-label">Transkrip Nilai terakhir yang sudah lulus MK Semester 1-6 dan KP</label>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label class="col-sm-3 col-form-label">Form Bebas Tunggakan / Pinjaman</label>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label class="col-sm-3 col-form-label">Print out bukti pengecekan Plagiarisme <= 25%</label>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label class="col-sm-3 col-form-label">Bukti Monitoring Hafalan</label>
