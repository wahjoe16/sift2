...
<section class="content">
    ...
    <div class="row">
        <div class="col-sm-12 col-xs-12">
            <form class="form-horizontal" action="{{ route('sidang_tmb.update', $data->id) }}" method="post" enctype="multipart/form-data">@csrf
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ route('seminar_tmb.index') }}" class="btn btn-light">Batal</a>
