        ...
        <div class="card">
            <div class="card-header">
                <div class="btn-group">
                    ...
                    <a href="{{ route('sidang_ti.daftar') }}" class="btn btn-success btn-sm"><i class="fas fa-upload"></i> Ajukan</a>
                    @endif
                </div>
            </div>
            <div class="card-body">
                <table class="table table-striped table-sidang">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('sidang_ti.show', $d->id) }}"><i class="fas fa-search"></i></a></td>
                            @endforeach
                        </tr>
                    </tbody>
                </table>
