                ...
                <div class="box-body">
                    <form action="{{ route('kegiatan-bukfis.upload', $kegiatan->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="nama_kegiatan" id="nama_kegiatan" value="{{ $kegiatan->nama_kegiatan }}" class="form-control" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="tanggal" id="tanggal" value="{{ $kegiatan->tanggal }}" class="form-control" disabled>
                                <span class="help-block with-errors"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select name="subcategory_id" id="subcategory_id" class="form-control select2" disabled>
                                    <option value="">Pilih</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select name="tingkat_id" id="tingkat_id" class="form-control select2" disabled>
                                    <option value="">Pilih</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select name="prestasi_id" id="prestasi_id" class="form-control select2" disabled>
                                    <option value="">Pilih</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select name="jabatan_id" id="jabatan_id" class="form-control select2" disabled>
                                    <option value="">Pilih</option>
