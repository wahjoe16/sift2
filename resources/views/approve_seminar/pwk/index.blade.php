...
<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
    <div>
        <h3 class="fw-bold">Approval Sidang Pembahasan</h3>
    </div>
</div>
                ...
                <table class="table table-striped table-approve-seminar">
                    <thead>
                        <tr>
                            ...
                            <th width="15%"><i class="fas fa-cogs"></i> Approve</th>
                        </tr>
                    </thead>
                </table>
            </div>
...
<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
    <div>
        <h3 class="fw-bold">Data Rekapitulasi Sidang Pembahasan</h3>
    </div>
</div>
...
<script>
    ...
    $(function() {
        ...
        table = $('.table-approve-seminar').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: "{{ route('view-seminarPwk.data') }}"
            },
            columns: [{
                    data: 'DT_RowIndex',
                    'searchable': false,
