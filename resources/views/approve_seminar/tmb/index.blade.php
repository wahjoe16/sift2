    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="btn-group">
                    <a href="{{ route('seminarTmbDownload.index') }}" class="btn btn-primary btn-sm"><i class="fas fa-download"></i> Unduh Dokumen</a>
                </div>
            </div>
            <div class="card-body">
                <table class="table table-striped table-approve-seminar">
                    <thead>
                        <tr>
                            <th width="5%">No</th>
                            <th>NPM</th>
                            ...
                            <th><i class="fas fa-cogs"></i> Approve</th>
                        </tr>
                    </thead>
                </table>
            </div>
...
<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row mt-4">
    <div>
        <h3 class="fw-bold">Data Rekapitulasi Kolokium Skripsi</h3>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-footer">
                <div class="btn-group">
                    <a href="{{ route('seminarTmbExcel.export') }}" class="btn btn-success btn-sm"><i class="fas fa-file-excel-o"></i> Export Excel</a>
...
<script>
    ...
    $(function() {
        ...
        table = $('.table-approve-seminar').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: "{{ route('view-seminarTmb.data') }}"
            },
            columns: [{
                    data: 'DT_RowIndex',
                    'searchable': false,
        ...
        table1 = $('.table-rekap-seminar').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: "{{ route('rekap-seminarTmb.data') }}",
                data: function(d) {
