...
<section class="content">
    ...
    <h3>Data Rekapitulasi Kolokium Skripsi</h3>
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="box box-warning">
                <div class="box-header with-border">
                ...
                <div class="box-footer">
                    <div class="btn-group">
                        <a href="{{ route('seminarTmbExcel.export') }}" class="btn btn-success btn-sm btn-flat"><i class="fa fa-file-excel-o"></i> Export Excel</a>
