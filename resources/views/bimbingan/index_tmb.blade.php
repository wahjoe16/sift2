...
<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
    <div>
        <h3 class="fw-bold">Data Mahasiswa Bimbingan</h3>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-striped table-bimbingan-1">
                    <thead>
                        <tr>
                            <th width="5%">No</th>
                            <th>NPM</th>
...
<div class="row mt-4">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5>Data Pembimbingan 2</h5>
            </div>
            <div class="card-body">
                <table class="table table-striped table-bimbingan-2">
                    <thead>
                        <tr>
                            <th width="5%">No</th>
                            <th>NPM</th>
