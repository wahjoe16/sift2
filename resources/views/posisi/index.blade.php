    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="btn-group">
                    <a href="{{ route('posisi-pekerjaan.create') }}" class="btn btn-success btn-sm"><i class="fas fa-plus-circle"></i> Tambah</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($data as $d => $value)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('posisi-pekerjaan.edit', $value->id) }}" class="btn btn-warning btn-xs"><i class="fas fa-pen"></i></a>
