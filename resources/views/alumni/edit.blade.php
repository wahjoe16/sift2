                ...
                <div class="box-body">
                    <form action="{{ route('alumni.update', $data->id) }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="nama" id="nama" class="form-control" required autofocus value="{{ $data->nama }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="nik" id="nik" class="form-control" required autofocus value="{{ $data->nik }}">
                                <span class="help-block with-errors"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="email" id="email" class="form-control" autofocus value="{{ $data->email }}">
                                <span class="help-block with-errors"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="telepon" id="telepon" class="form-control" autofocus value="{{ $data->telepon }}">
                                <span class="help-block with-errors"></span>
                            </div>
                        </div>
                        <div class="form-group row">
