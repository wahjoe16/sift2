                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="avatar avatar-xxl">
                            ...
                            <img class="avatar-img rounded-circle" src="{{ asset('storage/' . auth()->user()->foto) }}" alt="">
                            @else
                    ...
                    <input type="file" name="foto" class="dropify" id="foto" data-default-file="{{ asset('storage/' . auth()->user()->foto) }}"  required autofocus>
