@extends('layouts.portal.detail_profile')
                ...
                <ul class="list-group list-group-flush">
                    @foreach ($kompetensi as $k)
                        <li class="list-group-item" style="margin-left: 35px;">
                            ...
                            <p class="card-text" style="color: white; font-size: 15px; font-weight: 300; margin-top: -15px; margin-left: 26px""><a class="btn btn-info btn-sm" target="_blank" href="{{ url('/alumni/sertifikat', $k->sertifikat_kompetensi) }}"><i class="bi bi-link-45deg"></i> Lihat Sertifikat</a></p>
                        </li>
                    @endforeach
                </ul>
            </div>
