            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>4</td>
                            <td><a href="{{ asset('storage/' . $data->syarat_4) }}" target="_blank">Fotocopy Sertifikat Pesantren Calon Sarjana</a>
                            </td>
                        ...
                        <tr>
                            <td>7</td>
                            <td><a href="{{ asset('storage/' . $data->syarat_7) }}" target="_blank">Bukti Bebas Perpustakaan Pusat UNISBA</a></td>
                        ...
                        <tr>
                            <td>10</td>
                            <td><a href="{{ asset('storage/' . $data->syarat_10) }}" target="_blank">Persetujuan Sidang dari Dosen Pembimbing (Kartu Bimbingan Asli)</a></td>
                        ...
                        <tr>
                            <td>13</td>
                            <td><a href="{{ asset('storage/' . $data->syarat_13) }}" target="_blank">Bebas Pinjaman / Tunggakan</a></td>

                        </tr>
                        <tr>
                            <td>14</td>
                            <td><a href="{{ asset('storage/' . $data->syarat_14) }}" target="_blank">Menghadiri Seminar / Sidang minimal 3 kali</a>
                            </td>
