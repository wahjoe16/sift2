...
<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
    <div>
        <h3 class="fw-bold">Lulusan Program Studi Teknik Pertambangan</h3>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-footer">
                <div class="btn-group">
                    <a href="{{ route('sidangTmbExcel.export') }}" class="btn btn-success btn-sm"><i class="fas fa-file-excel-o"></i> Export Excel</a>
