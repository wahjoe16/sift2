    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="btn-group">
                    <a href="{{ route('sidangTmbDownload.index') }}" class="btn btn-primary btn-sm"><i class="fas fa-download"></i> Unduh Dokumen</a>
                </div>
            </div>
            <div class="card-body">
                <table class="table table-striped table-approve-sidang">
                    <thead>
                        <tr>
                            <th width="5%">No</th>
                            <th>NPM</th>
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-footer">
                <div class="btn-group">
                    <a href="{{ route('sidangTmbExcel.export') }}" class="btn btn-success btn-sm btn-flat"><i class="fa fa-file-excel-o"></i> Export Excel</a>
...
<script>
    ...
    $(function() {
        ...
        table1 = $('.table-rekap-sidang').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: "{{ route('rekap-sidangTmb.data') }}",
                data: function(d) {
