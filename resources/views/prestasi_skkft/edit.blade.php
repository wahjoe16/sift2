    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    <form action="{{ route('prestasi-skkft.update', $prestasi_skkft->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="form-group row">
                            <label for="prestasi" class="col-lg-2 col-lg-offset-1 control-label">Prestasi SKKFT</label>
                            <div class="col-lg-6">
                                <input type="text" name="prestasi" id="prestasi" value="{{ $prestasi_skkft->prestasi }}" class="form-control" required autofocus>
